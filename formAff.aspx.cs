...
public partial class formAff : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("formAff2.aspx?numff=" + numForm.Text + "");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            if (status.Checked)
            {
                ...
                {
                    sqlCon.Open();
                    string query = "insert into bulletin (mat,idForm) values (" + tab[i] + "," + numForm.Text + ") ";
