<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestFormG.aspx.cs" Inherits="gestFormG" %>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="acceuilGest.aspx"><i class="fa fa-dashboard fa-fw"></i> Acceuil</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                 ...
                                 <li>
                                    <a href="gesttFormG.aspx"> Tests</a>
                                </li>
        ...
        <div id="page-wrapper">
             ...
             <form id="form2" runat="server">
               ...
               <asp:HyperLinkField DataNavigateUrlFields="idForm" DataNavigateUrlFormatString="gestionModule.aspx?idForm={0}" text="voir" HeaderText=" Liste des Module" />
