<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestL.aspx.cs" Inherits="gestL" %>
...
<asp:GridView ID="gr1" runat="server" AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="idL"
  ...
  <EditRowStyle BackColor="#999999" Width="80%"  />
    ...
    <Columns>
         ...
         <asp:HyperLinkField DataNavigateUrlFields="idL" DataNavigateUrlFormatString="gestEx.aspx?idL={0}" text="voir" HeaderText=" Liste des leçons" />   
