<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestModG.aspx.cs" Inherits="gestModG" %>
...
<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
                     ...
                     <br />
                     <br />
                                <asp:DataList ID="DataList1" runat="server" DataKeyField="idForm" DataSourceID="SqlDataSource2">
                                    <ItemTemplate>
                                      
                                        <asp:Label ID="idFormLabel" runat="server" Text='<%# Eval("idForm") %>' Visible="false" />
                                        
                                        <h1> Nom: </h1>
                                        <h2> <asp:Label ID="nomFormLabel" runat="server" Text='<%# Eval("nomForm") %>' /> </h2>
                                        <br />
                                      <h1> Description: </h1> 
                                        <h2><asp:Label ID="descFormLabel" runat="server" Text='<%# Eval("descForm") %>' /> </h2>
                                        <br />
<br />
                                    </ItemTemplate>
                     </asp:DataList>
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:pfeConnectionString20 %>" SelectCommand="SELECT * FROM [formation1] WHERE ([idForm] = @idForm)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="Label1" Name="idForm" PropertyName="Text" Type="Int32"  />
                                    </SelectParameters>
                     </asp:SqlDataSource>

                   
                     <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Chercher" CssClass="button1" />  
                          </center>        
                 </div>
                 </form>
