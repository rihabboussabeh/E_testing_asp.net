<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestModule.aspx.cs" Inherits="gestModule" %>
                         ...
                         OnRowDeleting="gr1_RowDeleting">
                          ...
                          <Columns>
                             ...
                             ErrorMessage="Nom du Module obligatoirement chaine de caracétre" Text="*"></asp:RegularExpressionValidator>
                                     ...
                                     <asp:HyperLinkField DataNavigateUrlFields="idMod" DataNavigateUrlFormatString="gestL.aspx?idMod={0}" text="voir" HeaderText=" Liste des leçons" />     
                               <asp:TemplateField>
                                   <ItemTemplate>
