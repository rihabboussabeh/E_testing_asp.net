<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestQ.aspx.cs" Inherits="gestQ" %>
...
OnRowCommand="gr1_RowCommand" OnRowEditing="gr1_RowEditing" OnRowCancelingEdit="gr1_RowCancelingEdit" OnRowUpdating="gr1_RowUpdating" 
    ...
    <Columns>
         ...
         <asp:HyperLinkField DataNavigateUrlFields="idQ" DataNavigateUrlFormatString="gestProp.aspx?idQ={0}" text="voir" HeaderText="Propositions" />   
