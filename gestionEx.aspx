<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestionEx.aspx.cs" Inherits="gestionEx" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="idEx" DataSourceID="SqlDataSource1"
     ...
     <Columns>
        ...
        <asp:BoundField DataField="type" HeaderText="type" SortExpression="type" />
             ...
             <asp:HyperLinkField DataNavigateUrlFields="idEx" DataNavigateUrlFormatString="gestionQ.aspx?idEx={0}" text="Voir" HeaderText=" Liste des Questions" />   
    </Columns>
                          </asp:GridView>
