<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestionModule.aspx.cs" Inherits="gestionModule" %>
    ...
    <div id="wrapper">
             ...
             <form id="form1" runat="server">
                 <div>
                      <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
                       <center> <h1> <span> Liste Des Modules de Formation </span> 
                     ...
                     <asp:GridView ID="gr1" runat="server" AutoGenerateColumns="False" ShowFooter="True" DataKeyNames="idMod"
                         ...
                         OnRowDeleting="gr1_RowDeleting">
                          ...
                          <Columns>
                             ...
                             ControlToValidate="TxtnomMod" EnableClientScript="False" ValidationExpression="[a-zA-Z]{3}[a-zA-Z]*([a-zA-Z]|\s)*"
                             ErrorMessage="Nom du Module est obligatoirement chaine de caracétre" Text="*"></asp:RegularExpressionValidator>
                                    </EditItemTemplate>
                             ...
                             ControlToValidate="TxtnomModFooter" EnableClientScript="False" ValidationExpression="[a-zA-Z]{3}[a-zA-Z]*([a-zA-Z]|\s)*"
                             ErrorMessage="Nom du Module obligatoirement chaine de caracétre" Text="*"></asp:RegularExpressionValidator>
                                    </FooterTemplate>
                                </asp:TemplateField>

                                     <asp:HyperLinkField DataNavigateUrlFields="idMod" DataNavigateUrlFormatString="gestionL.aspx?idMod={0}" text="voir" HeaderText=" Liste des leçons" />     
                               <asp:TemplateField>
                                   <ItemTemplate>
        ...
        <EditRowStyle BackColor="#999999" />
                  ...
                  <h4>  <asp:Label ID="lblErrorMessage" runat="server" Text="" ForeColor="Red"></asp:Label> </h4>
                     ...
                     <center> 
                    <h2> <asp:Label ID="lnomFormV" runat="server" ></asp:Label>
 <h2><asp:Label ID="LformExiste" runat="server" ></asp:Label> 
                      <asp:Label ID="lMsgVide" runat="server" Text="" ForeColor="red"></asp:Label>
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" />
<asp:ValidationSummary ID="ValidationSummary2" runat="server"></asp:ValidationSummary>
                        </h2></center>
                        
                    <center>  <asp:Button ID="Button1" runat="server" Text="Liste des Formations" OnClick="Button1_Click" CssClass="button1" /> </center>
                 </div>
                 </form>
