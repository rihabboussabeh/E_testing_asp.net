<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gestionQ.aspx.cs" Inherits="gestionQ" %>
            ...
            <br />
             ...
             <form id="form1" runat="server">
                 <div>
                      ...
                      <center> <h1> <span> Liste Des Qestions d'exercice </span>  <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
                          <br />
<asp:Label ID="lidQ" runat="server" ></asp:Label>
...
OnRowCommand="gr1_RowCommand" OnRowEditing="gr1_RowEditing" OnRowCancelingEdit="gr1_RowCancelingEdit" OnRowUpdating="gr1_RowUpdating" 
    ...
    <Columns>
         ...
         <asp:TemplateField HeaderText="Numéro " Visible="false">
                                    <ItemTemplate>
                                        <asp:Label runat="server" Text='<%# Eval("numQ") %>'></asp:Label>
                                    </ItemTemplate>

                                    <EditItemTemplate>
                                        <asp:TextBox ID="TxtnumQ" Text='<%# Eval("numQ") %>' runat="server"> </asp:TextBox>
                                    </EditItemTemplate>

                                    <FooterTemplate>
                                        <asp:TextBox ID="TxtnumQFooter" runat="server"> </asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>

            <asp:TemplateField HeaderText="nom ">
                                    <ItemTemplate>
                                        <asp:Label runat="server" Text='<%# Eval("nomQ") %>'></asp:Label>
                                    </ItemTemplate>

                                    <EditItemTemplate>
                                        <asp:TextBox ID="TxtnomQ" Text='<%# Eval("nomQ") %>' runat="server"> </asp:TextBox>
                                    </EditItemTemplate>

                                    <FooterTemplate>
                                        <asp:TextBox ID="TxtnomQFooter" runat="server"> </asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>

                <asp:TemplateField HeaderText="bareme ">
                                    <ItemTemplate>
                                        <asp:Label runat="server" Text='<%# Eval("bareme ") %>'></asp:Label>
                                    </ItemTemplate>

                                    <EditItemTemplate>
                                        <asp:TextBox ID="Txtbareme" Text='<%# Eval("bareme ") %>' runat="server"> </asp:TextBox>
                                    </EditItemTemplate>

                                    <FooterTemplate>
                                        <asp:TextBox ID="TxtbaremeFooter" runat="server"> </asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>

         <asp:HyperLinkField DataNavigateUrlFields="idQ" DataNavigateUrlFormatString="gestionProp.aspx?idQ={0}" text="voir" HeaderText="Propositions" />   
